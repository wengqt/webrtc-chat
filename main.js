(function () {
  ...
  function connectPeers() {
    ...
    //     console.log(JSON.stringify(localConnection))
    ...
    //   .then(() => console.log(document.getElementById('offer').textContent= JSON.stringify(localConnection.localDescription)))
    //   .then(()=> {
    //       setTimeout( function(){
    ...
    var peer = new Peer('ackackack',{ debug: 3});
    
      
    peer.on("open", function (id) {
      console.log("My peer ID is: " + id);
      var conn = peer.connect("wengwengweng-kaiss1", peerOptions);
  ...
  function sendMsg(){
    if(connection){
        connection.send({data: "hi! from " + 123});
    }
  }
